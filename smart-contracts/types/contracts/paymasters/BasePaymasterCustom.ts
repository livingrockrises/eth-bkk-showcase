...
export interface BasePaymasterCustomInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
...
export interface BasePaymasterCustom extends BaseContract {
  connect(runner?: ContractRunner | null): BasePaymasterCustom;
  waitForDeployment(): Promise<this>;

  interface: BasePaymasterCustomInterface;
