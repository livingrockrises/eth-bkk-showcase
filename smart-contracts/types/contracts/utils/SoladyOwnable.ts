...
export interface SoladyOwnableInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SoladyOwnable extends BaseContract {
  connect(runner?: ContractRunner | null): SoladyOwnable;
  waitForDeployment(): Promise<this>;

  interface: SoladyOwnableInterface;
