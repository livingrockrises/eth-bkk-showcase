...
export interface NFTPurchaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTPurchase extends BaseContract {
  connect(runner?: ContractRunner | null): NFTPurchase;
  waitForDeployment(): Promise<this>;

  interface: NFTPurchaseInterface;
