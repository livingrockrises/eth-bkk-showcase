...
export interface BlueChipNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "MINT_PRICE"
...
export interface BlueChipNFT extends BaseContract {
  connect(runner?: ContractRunner | null): BlueChipNFT;
  waitForDeployment(): Promise<this>;

  interface: BlueChipNFTInterface;
